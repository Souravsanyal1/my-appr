    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // ════════════════════════════════════════════════════════
          Obx(() {
            final allGranted = controller.hasUsagePermission.value &&
            ...
            if (allGranted) {
              return Container(
                ...
                child: const Row(
                  children: [
                    Icon(Icons.verified_user_rounded, color: AppColors.primaryEmerald),
                    SizedBox(width: 12),
                    Expanded(
                      child: Column(
          ...
          _buildSettingsCard(
            ...
            children: [
              Obx(() => SwitchListTile(
                    title: const Text('Strict Mode', style: TextStyle(fontWeight: FontWeight.bold)),
                    subtitle: const Text('Require 4-digit PIN for unlocks and modifying limits'),
              ...
              ListTile(
                leading: const Icon(Icons.pin, color: AppColors.secondaryGold),
                title: const Text('Change Security PIN'),
                subtitle: const Text('Secure SHA-256 hashed on-device storage'),
          ...
          _buildSettingsCard(
            ...
            children: [
              ListTile(
                title: const Text('Passing Threshold', style: TextStyle(fontWeight: FontWeight.bold)),
                subtitle: const Text('Minimum score required to earn an unlock pass'),
                trailing: Obx(() => DropdownButton<int>(
                      ...
                      items: const [
                        ...
                        DropdownMenuItem(value: 80, child: Text('80% (Default)')),
              ...
              const Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 6),
                    Text('• 70% – 79% score → 5 minutes access', style: TextStyle(fontSize: 12, color: Colors.grey)),
                    Text('• 80% – 89% score → 10 minutes access', style: TextStyle(fontSize: 12, color: Colors.grey)),
                    Text('• 90%+ score → 15 minutes access', style: TextStyle(fontSize: 12, color: Colors.grey)),
                  ],
                ),
              ),
            ],
          ...
          _buildSettingsCard(
            ...
            children: [
              Obx(() => SwitchListTile(
                    ...
                    subtitle: const Text('Alert at 5 minutes and 1 minute remaining'),
              ...
              Obx(() => SwitchListTile(
                    ...
                    subtitle: const Text('Mindful notification when streak is waiting'),
          ...
          _buildSettingsCard(
            ...
            children: [
              const ListTile(
                leading: Icon(Icons.lock_clock, color: AppColors.primaryEmerald),
                title: Text('Offline & Local-First'),
                subtitle: Text('App usage data & PIN remain securely on your device.'),
              ),
              const Divider(height: 1),
              ListTile(
                leading: const Icon(Icons.mic_off_outlined, color: Colors.blueAccent),
                title: const Text('Microphone Privacy'),
                subtitle: const Text('Audio is only captured during recitation practice and analyzed immediately.'),
              ),
              const Divider(height: 1),
              ListTile(
                leading: const Icon(Icons.cleaning_services_outlined, color: Colors.orangeAccent),
                title: const Text('Clear Audio Caches'),
                subtitle: const Text('Delete temporary recitation audio files'),
                onTap: controller.clearAudioRecordings,
              ),
              const Divider(height: 1),
              ListTile(
                leading: const Icon(Icons.delete_forever, color: AppColors.danger),
                title: const Text('Factory Reset Data', style: TextStyle(color: AppColors.danger)),
                subtitle: const Text('Erase all limits, schedules, and start onboarding anew'),
