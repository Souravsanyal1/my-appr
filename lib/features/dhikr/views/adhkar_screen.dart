...
class AdhkarScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final morningAdhkar = [
      ...
      },
      {
        ...
        'meaning': 'O Allah, You are my Lord, there is none worthy of worship except You. You created me and I am Your servant...',
        'reward': 'Whoever says it with conviction and dies that day will enter Jannah (Bukhari).',
        'count': '1x',
      },
      {
        ...
        'meaning': 'In the Name of Allah, with Whose Name nothing can cause harm in the earth nor in the heavens...',
      ...
      },
      {
        ...
        'reward': 'Allah has promised that He will satisfy him on the Day of Resurrection.',
        'count': '3x',
      },
    ];
        ...
        appBar: AppBar(
          ...
          bottom: const TabBar(
            ...
            tabs: [
              ...
              Tab(text: 'Evening Adhkar', icon: Icon(Icons.nightlight_round_outlined)),
            ],
          ),
        ),
        body: TabBarView(
          children: [
            ...
            _buildAdhkarList(context, morningAdhkar, isDark), // Shared collection for morning/evening
          ],
        ),
      ),
    );
  ...
  Widget _buildAdhkarList(BuildContext context, List<Map<String, String>> list, bool isDark) {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.info_outline, size: 16, color: AppColors.emerald),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Text(
                        item['reward']!,
                        style: const TextStyle(fontSize: 11, color: AppColors.emerald),
                      ),
                    ),
                  ],
                ),
